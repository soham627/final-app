class UserAuthenticationController < ApplicationController
  ...
  skip_before_action(:force_user_sign_in, { :only => [:sign_up_form, :create, :sign_in_form, :create_cookie, :destroy_cookies] })
  ...
  def destroy_cookies
    ...
    redirect_to("/jobs/", { :notice => "Signed out successfully." })
  end
